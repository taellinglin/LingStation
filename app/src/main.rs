...
impl Default for DawApp {
    fn default() -> Self {
        ...
        let track_audio: Vec<TrackAudioState> = Vec::new();
        let track_mix_states: Vec<TrackMixState> = Vec::new();
        let node_activity_states: Vec<TrackNodeActivity> = Vec::new();
        ...
        *engine.node_activity.lock() = node_activity_states;
        ...
        let mut app = Self {
            project_name: "LingStation".to_string(),
