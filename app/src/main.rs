    ...
    fn default() -> Self {
        ...
        *engine.node_activity.lock() = node_activity_states;
        ...
        let mut app = Self {
            ...
            render_bitrate: 320,
            render_ogg_quality: 0.4,
            render_flac_bit_depth: RenderWavBitDepth::Int24,
            ...
            ai_score_prompt: String::new(),
            ai_score_status: String::new(),
            ai_score_journal: Vec::new(),
            ai_score_response: String::new(),
            ai_score_job: None,
            ai_score_busy: false,
            ai_score_bars: 16,
